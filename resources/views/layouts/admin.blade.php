...
<head>
    ...
    <title>{{ $title }}</title>
    @include('partials.dashboard.head-script')
</head>

<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="{{ url('index.html') }}">{{ config('app.name') }}</a>
        <!-- Sidebar Toggle-->
        ...
        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" id="navbarDropdown" href="{{ url('#') }}" role="button"
                    data-bs-toggle="dropdown" aria-expanded="false"><i class="fas fa-user fa-fw"></i></a>
                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li class="dropdown-item">{{ auth()->user()->name }}</li>
                    <li><a class="dropdown-item" href="{{ url('#!') }}">Profil Saya</a></li>
                    <li>
                    ...
                    <li class="dropdown-item">
                        <form action="{{ route('logout') }}" method="post">
                            @csrf
                            <button class="btn border-0 p-0 w-100 text-start">Keluar</button>
                        </form>
                    </li>
                </ul>
            </li>
    ...
    @include('partials.dashboard.footer-script')
</body>
